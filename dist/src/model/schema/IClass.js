...
exports.ClassSearchOLD = exports.ClassRepository = exports.ClassModel = exports.Class = exports.ClassSearch = void 0;
...
exports.Class = Class;
class ClassSearch extends c2_mongoose_1.SearchFlow {
    constructor(params) {
        super(params);
        this.buildFilters();
    }
...
class ClassSearchOLD extends Search_1.default {
    constructor(_query) {
        super(_query);
        this.model = _query;
...
exports.ClassSearchOLD = ClassSearchOLD;
