...
const FinancialModel = {
    ...
    status: { type: String, enum: StatusOfFinancial_1.default, required: true, default: StatusOfFinancial_1.default.OPENED },
    type: { type: String, enum: TypeOfFinancial_1.default, required: true },
    ...
    payments: [{
            ...
            paymentMethod: { type: String, enum: PaymentMethod_1.default, required: true, default: PaymentMethod_1.default.CASH }
        }]
};
