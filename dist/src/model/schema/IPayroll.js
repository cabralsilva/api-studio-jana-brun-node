...
exports.PayrollSearchOLD = exports.PayrollRepository = exports.PayrollEmployeeDetail = exports.PayrollMonthly = exports.PayrollModel = exports.Payroll = exports.PayrollSearch = void 0;
...
const PayrollEmployeeDetail = {
    ...
    payments: [
        {
            type: { type: String, enum: TypeOfPayroll_1.default, required: true },
            total: { type: Number },
...
class PayrollSearch extends c2_mongoose_1.SearchFlow {
    constructor(params) {
        super(params);
        this.buildFilters();
    }
...
class PayrollSearchOLD extends Search_1.default {
    constructor(_query) {
        super(_query);
        this.buildFilters();
    }
...
exports.PayrollSearchOLD = PayrollSearchOLD;
