...
class GetPayrollByIdFlow extends Http_1.Http {
    constructor() {
        super(...arguments);
        ...
        this.get = (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                const searcher = new IPayroll_1.PayrollSearch(Object.assign(Object.assign({}, request.query), { _id: request.params.id }));
                this.searcherPayroll.prepareSearch(searcher);
                const clazz = yield this.searcherPayroll.getOne({
...
exports.default = new GetPayrollByIdFlow;
