...
class GetClassByIdFlow extends Http_1.Http {
    constructor() {
        super(...arguments);
        this.searcherClass = new c2_mongoose_1.CrudFlow(IClass_1.ClassRepository);
        this.get = (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                const searcher = new IClass_1.ClassSearch(Object.assign(Object.assign({}, request.query), { _id: request.params.id }));
                this.searcherClass.prepareSearch(searcher);
                const clazz = yield this.searcherClass.getOne({
...
exports.default = new GetClassByIdFlow;
