...
class SearchClassFlow extends Http_1.Http {
    constructor() {
        super(...arguments);
    ...
    search(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.crudClass.prepareSearch(new IClass_1.ClassSearch(search));
                let response = yield this.crudClass.find({});
...
exports.default = new SearchClassFlow;
