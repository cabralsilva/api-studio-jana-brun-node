...
class GetSaleByIdFlowItem extends Http_1.Http {
    constructor() {
        super(...arguments);
        ...
        this.get = (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                const searcher = new ISale_1.SaleSearch(Object.assign(Object.assign({}, request.query), { _id: request.params.id }));
                this.searcherSale.prepareSearch(searcher);
                const sale = yield this.searcherSale.getOne({
                    _id: request.params.id
                });
                if ((0, Utils_1.isEmpty)(sale)) {
...
exports.default = new GetSaleByIdFlowItem;
