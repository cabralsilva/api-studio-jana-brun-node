            ...
            try {
                ...
                if (req.body.student) {
                    if (req.body.student.person) {
                        yield UpdateFlowItem_2.default.update(req.body.student.person._id, req.body.student.person, session);
                    }
                    yield UpdateFlowItem_1.default.update(req.body.student._id, req.body.student, session);
                }
