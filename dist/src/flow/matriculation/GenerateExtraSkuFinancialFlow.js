    ...
    generate(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const matriculation = yield GetByIdFlowItem_1.default.get(req.params.id, "paymentConditionExtra student");
                ...
                yield UpdateFlowItem_1.default.update(matriculation._id.toString(), { extraSkuFinancialCreated: true }, session);
...
exports.default = new GenerateExtraSkuFinancial;
