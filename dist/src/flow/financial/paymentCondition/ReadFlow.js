        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (Utils_1.default.isNotEmpty((_a = req.params) === null || _a === void 0 ? void 0 : _a.id)) {
                    const paymentCondition = yield GetByIdFlowItem_1.default.get(req.params.id);
                ...
                var resultSearch = yield FindBySearchFlowItem_1.default.find(new IPaymentCondition_1.PaymentConditionSearch(req.query));
