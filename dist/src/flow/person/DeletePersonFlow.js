...
class DeletePersonFlow extends Http_1.Http {
    constructor() {
        super(...arguments);
    ...
    delete(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield this.crudPerson.deleteById(new mongoose_1.Types.ObjectId(request.params.id), { session, logger: false });
...
exports.default = new DeletePersonFlow;
