...
class SearchProductFlow extends Http_1.Http {
    constructor() {
        super(...arguments);
        this.crudProduct = new c2_mongoose_1.CrudFlow(IProduct_1.ProductRepository);
    }
    search(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const search = Object.assign({}, request.query);
                this.crudProduct.prepareSearch(new IProduct_1.ProductSearch(search));
                let response = yield this.crudProduct.find({});
...
exports.default = new SearchProductFlow;
