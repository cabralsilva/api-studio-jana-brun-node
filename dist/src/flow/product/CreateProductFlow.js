...
class CreateProductFlow extends Http_1.Http {
    constructor() {
        super(...arguments);
    ...
    create(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const productAfter = yield this.crudProduct.create(payload, { session, logger: false });
                yield session.commitTransaction();
                return [http_status_1.OK, Object.assign({ message: (0, i18n_1.getMessage)("message.registerCreatedSuccess") }, productAfter)];
            }
            catch (error) {
...
exports.default = new CreateProductFlow;
