        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (Utils_1.default.isNotEmpty((_a = req.params) === null || _a === void 0 ? void 0 : _a.id)) {
                    const product = yield GetByIdFlowItem_1.default.get(req.params.id, {
                        path: 'grates',
                        model: 'grate'
                    });
                    if (Utils_1.default.isEmpty(product)) {
                        throw new HttpError_1.default(HttpStatus.NOT_FOUND, StringUtils_1.default.message("message.registerNotFounded"));
                    }
                    return product;
                }
                var resultSearch = yield FindBySearchFlowItem_1.default.find(new IProduct_1.ProductSearch(req.query));
