        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (Utils_1.default.isNotEmpty((_a = req.params) === null || _a === void 0 ? void 0 : _a.id)) {
                    const student = yield GetByIdFlowItem_1.default.get(req.params.id, {
                        path: 'person.address',
                        populate: {
                            path: 'city',
                            populate: {
                    ...
                    if (Utils_1.default.isEmpty(student)) {
                        throw new HttpError_1.default(HttpStatus.NOT_FOUND, StringUtils_1.default.message("message.registerNotFounded"));
                    }
                    return student;
                }
                var resultSearch = yield FindBySearchFlowItem_1.default.find(new Student_1.StudentSearch(req.query));
