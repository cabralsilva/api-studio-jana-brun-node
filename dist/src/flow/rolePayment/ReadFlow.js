        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (Utils_1.default.isNotEmpty((_a = req.params) === null || _a === void 0 ? void 0 : _a.id)) {
                    const rolePayment = yield GetByIdFlowItem_1.default.get(req.params.id);
                    if (Utils_1.default.isEmpty(rolePayment)) {
                        throw new HttpError_1.default(HttpStatus.NOT_FOUND, (0, i18n_1.getMessage)("message.registerNotFounded"));
                    }
                    return rolePayment;
                }
                var resultSearch = yield FindBySearchFlowItem_1.default.find(new RolePayment_1.RolePaymentSearch(req.query));
