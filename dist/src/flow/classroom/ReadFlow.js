...
const Classroom_1 = require("../../model/schema/Classroom");
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (Utils_1.default.isNotEmpty((_a = req.params) === null || _a === void 0 ? void 0 : _a.id)) {
                    const classroom = yield GetByIdFlowItem_1.default.get(req.params.id);
                    if (Utils_1.default.isEmpty(classroom)) {
                        throw new HttpError_1.default(HttpStatus.NOT_FOUND, StringUtils_1.default.message("message.registerNotFounded"));
                    }
                    return classroom;
                }
                var resultSearch = yield FindBySearchFlowItem_1.default.find(new Classroom_1.ClassroomSearch(req.query));
